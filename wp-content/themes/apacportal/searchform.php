<form action="http://spsearch.fiat.com/search" target="_blank" class="navbar-search pull-right">
    ...
    <input type="hidden" name="site" value="apaconn_fiat_chrysler">
    <input type="hidden" name="client" value="apaconn_fiat_chrysler">
    <input type="hidden" name="btnG" value="Search APAConnect">
